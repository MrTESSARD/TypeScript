...
// Person.prototype.talk();//accecible uniquement si pas private 
class Exemple {
    static proprietePrivee = "Ceci est une propriété privée statique.";
    proprieteInstance = "Ceci est une propriété privée d'instance.";
    static afficherProprietePriveeStatique() {
        console.log(Exemple.proprietePrivee);
    }
    afficherProprieteInstance() {
